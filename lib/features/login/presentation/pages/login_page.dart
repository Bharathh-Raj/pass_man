...
final GlobalKey<ScaffoldState> logInPageKey = new GlobalKey<ScaffoldState>();

class LoginPage extends StatelessWidget {
  final Function onPressedFunction;

  const LoginPage({Key key, this.onPressedFunction}) : super(key: key);
  @override
                  ...
                  Container(
                    ...
                    child: Center(
                      ...
                      children: [
                        ...
                        Text(
                          'Login',
                          style: GoogleFonts.pacifico().copyWith(color: Colors.blueGrey).copyWith(fontSize: 16),
                        ),
                        SizedBox(
                          height: 30,
                        ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        'G',
                                        style: GoogleFonts.pacifico().copyWith(color: Colors.white).copyWith(fontSize: 18),
                                      ),
                                    ),
                                    Text(
                                      "Google",
